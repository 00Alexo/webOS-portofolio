...
const GoogleApp = ({setOpenApps, bringToFront, appId, openApps, focusedAppId}) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className={`flex px-2 pt-2 justify-end bg-white/90 drag-handle cursor-move backdrop-blur-sm border-b border-white/20 ${isMaxSize ? 'rounded-none' : 'rounded-t-lg'}`}>
